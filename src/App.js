...
import './App.css';
import {CodingQuiz, WeatherDashboard, PasswordGenerator, Gmail, LinkedIn, Github, Indeed} from "./assets/index.js";
function App() {
  return (

    <><h1 className="CenterLinks">Welcome to My Portfolio!</h1><div className="App">
      <ul>
        <li id="Link 1">
    ...
    <p><a href="https://www.github.com">
      ...
      <p><a href="https://www.linkedin.com">
        ...
        <p><a href="https://www.indeed.com">
          <img id="Indeed" src={Indeed} alt="Indeed" />
          </a></p>
